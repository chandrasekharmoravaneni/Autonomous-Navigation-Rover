#!/usr/bin/env python3
"""
Minimal IMU logger for EKF (Python).
...
This is ready to feed into a custom EKF (Python/C++).
"""
...
def main():
    ...
    # Open output file
    out_file = open("imu_ekf_data.json", "w")
    out_file.write("[\n")
    first_record = True
    ...
    for msg, meta in framer:
        ...
        if isinstance(msg, MsgImuRaw):
            ...
            print("IMU EKF:", record, flush=True)

    # Clean exit
    out_file.write("\n]\n")
    out_file.close()
    print("\nJSON saved as imu_ekf_data.json\nDone.\n")
